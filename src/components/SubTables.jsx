...
import { deleteTeamMember, deleteAmmunition, deleteAttachment } from '../store/operationsSlice.js';
import TeamModal from './TeamModal.jsx';
import AmmunitionModal from './AmmunitionModal.jsx';
import AttachmentModal from './AttachmentModal.jsx';
import { FaUsers, FaBomb, FaPaperclip, FaPlus, FaEdit, FaTrash } from 'react-icons/fa';
          ...
          <div className="col-lg-4">
            <div className="card card-custom h-100">
              <div className="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-light btn-sm" onClick={handleAddTeam}>
                  <FaPlus />
                </button>
              </div>
          ...
          <div className="col-lg-4">
            <div className="card card-custom h-100">
              <div className="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-dark btn-sm" onClick={handleAddAmmunition}>
                  <FaPlus />
                </button>
              </div>
              <div className="card-body p-0">
          ...
          <div className="col-lg-4">
            <div className="card card-custom h-100">
              <div className="card-header bg-info text-white d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-light btn-sm" onClick={handleAddAttachment}>
                  <FaPlus />
                </button>
              </div>
              <div className="card-body p-0">
